...
namespace Backend_.Net.Migrations
{
    ...
    [Migration("20250614191743_SecondInitialData")]
    partial class SecondInitialData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend_.Net.Entities.DesignConcept", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Backend_.Net.Entities.Color", b =>
                {
                    b.HasOne("Backend_.Net.Entities.Design", null)
                        .WithMany("Colors")
